class FormAnswersController < ApplicationController
  ...
  def index
    ...
    @form_answers = policy_scope(FormAnswer)
  end
  ...
  def create
    ...
    respond_to do |format|
      if @form_answer.save
        format.html { redirect_to @form_answer, notice: t(".success") }
  ...
  def update
    respond_to do |format|
      if @form_answer.update(form_answer_params)
        format.html { redirect_to @form_answer, notice: t(".success"), status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to form_answers_path, notice: t(".success"), status: :see_other }
  ...
  private
    ...
    def set_form_answer
      @form_answer = policy_scope(FormAnswer).find(params.expect(:id))
      authorize @form_answer
    end
